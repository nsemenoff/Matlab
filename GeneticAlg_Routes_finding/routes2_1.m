...
for i=10:1:45
    ...
    for test=1:50
            ...
            for l=2:size(route,1)-1
                ...
                for x1=-1:1
                    for y1=-1:1
                        ...
                        if (power2 < power) && (calc_distance(route2) < max_len*1.1)
                            route = route2;
                            power = power2;
                        end
                    end
        ...
        if old_power > power % calc_power(fld,route)
%            [old_power, grid] = calc_power(fld,route);
%            [old_power, grid] = calc_power(fld,route);
            old_power = power;
            fig1 = figure;
            clf
    ...
    %        axis([0.5 10.5 0.5 10.5])
            ...
            colors = ['rgbcmykrgbcmykrgbcmykrgbcmykrgbcmykrgbcmykrgbcmykrgbcmykrgbcmykrgbcmyk'];
            colors = ['rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr'];
            for i=1:N
                for j=1:N
